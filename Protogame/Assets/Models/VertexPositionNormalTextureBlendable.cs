namespace Protogame
{
    ...
    /// incorporates the position, normal and texture UVs, as well as the bone indices
    /// and bone weightings that impact this vertex.
    /// </remarks>
    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct VertexPositionNormalTextureBlendable : IVertexType
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="VertexPositionNormalTextureBlendable"/> struct.
        /// </summary>
        static VertexPositionNormalTextureBlendable()
        {
        ...
        /// The bone IDs that apply to the vertex.
        /// </param>
        public VertexPositionNormalTextureBlendable(
            Vector3 position, 
            Vector3 normal, 
        ...
        /// </returns>
        public static bool operator ==(VertexPositionNormalTextureBlendable left, VertexPositionNormalTextureBlendable right)
        {
        ...
        public override string ToString()
        {
            return string.Format(
                "{{Position:{0} Normal:{1} TextureCoordinate:{2} BlendWeight:{3} BlendIndexes:{4}}}", 
                new object[] { this.Position, this.Normal, this.TextureCoordinate, this.BoneWeights, this.BoneIndices });
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is VertexPositionNormalTextureBlendable && this.Equals((VertexPositionNormalTextureBlendable)obj);
        }
