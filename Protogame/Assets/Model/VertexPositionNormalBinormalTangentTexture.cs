namespace Protogame
{
    ...
    public struct VertexPositionNormalBinormalTangentTexture : IVertexType
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="VertexPositionNormalBinormalTangentTexture"/> struct.
        /// </summary>
        static VertexPositionNormalBinormalTangentTexture()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VertexPositionNormalBinormalTangentTexture"/> struct.
        /// </summary>
        /// <param name="position">
        /// The position of the vertex.
        /// </param>
        ...
        /// The texture coordinate for the vertex.
        /// </param>
        public VertexPositionNormalBinormalTangentTexture(
            Vector3 position, 
            Vector3 normal,
            Vector3 binormal,
            Vector3 tangent,
        ...
        /// </returns>
        public static bool operator ==(VertexPositionNormalBinormalTangentTexture left, VertexPositionNormalBinormalTangentTexture right)
        {
        ...
        public override string ToString()
        {
            return string.Format(
                "{{Position:{0} Normal:{1} Binormal:{2} Tangent:{3} TextureCoordinate:{4}}}", 
                new object[] { this.Position, this.Normal, this.Binormal, this.Tangent, this.TextureCoordinate });
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is VertexPositionNormalBinormalTangentTexture && this.Equals((VertexPositionNormalBinormalTangentTexture)obj);
        }
