namespace Protogame
{
    ...
    /// </summary>
    public class EffectWithMatricesAndTextureAndBones : Effect, IEffectMatrices, IEffectTexture, IEffectBones
    {
        ...
        private Matrix[] m_Bones = new Matrix[MAX_BONES];
        ...
        private EffectParameter m_BonesParam;
        ...
        /// </param>
        public EffectWithMatricesAndTextureAndBones(GraphicsDevice device, byte[] bytecode, bool seperatedMatrixes)
        ...
        /// The clone source.
        /// </param>
        protected EffectWithMatricesAndTextureAndBones(EffectWithMatricesAndTextureAndBones cloneSource)
            : base(cloneSource)
        {
            ...
            this.m_Bones = cloneSource.m_Bones;
        }
        ...
        {
            return new EffectWithMatricesAndTextureAndBones(this);
        }
        ...
        protected override bool OnApply()
        {
            ...
            this.m_BonesParam.SetValue(this.m_Bones);
        ...
        private void CacheEffectParameters()
        {
            ...
            this.m_BonesParam = this.Parameters["Bones"];
        }
    }
}