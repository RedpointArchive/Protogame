namespace Protogame
{
    ...
    public class DualIPEndPoint : IEquatable<DualIPEndPoint>
    {
        ...
        public bool Equals(DualIPEndPoint other)
        {
            ...
            return Equals(this.RealtimeEndPoint, other.RealtimeEndPoint)
                   && Equals(this.ReliableEndPoint, other.ReliableEndPoint);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals((DualIPEndPoint)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return ((this.RealtimeEndPoint != null ? this.RealtimeEndPoint.GetHashCode() : 0) * 397)
                       ^ (this.ReliableEndPoint != null ? this.ReliableEndPoint.GetHashCode() : 0);
            }
        }
        ...
        public override string ToString()
        {
            ...
            {
                return this.RealtimeEndPoint.Address + ":U" + this.RealtimeEndPoint.Port + ":R"
                       + this.ReliableEndPoint.Port;
            }

            if (this.RealtimeEndPoint == null)
            {
