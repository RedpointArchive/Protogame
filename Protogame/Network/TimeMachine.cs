namespace Protogame
{
    ...
    /// </summary>
    public abstract class TimeMachine<T> where T : struct
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="history">The amount of history to keep in ticks.</param>
        ...
        /// </summary>
        /// <param name="tick">The tick at which this value exists.</param>
        /// <param name="value">The value to store in the time machine.</param>
        ...
        /// </summary>
        /// <param name="tick">The tick at which to retrieve the value.</param>
        ...
        /// <param name="b">The value to subtract by.</param>
        ...
        /// </summary>
        /// <returns>The resulting value.</returns>
        /// <param name="a">The first value for .</param>
        /// <param name="b">The second value for multiplication.</param>
        ...
        /// <summary>
        /// Return whether the specified value represents zero, in which case it would not be safe to call <see cref="DivideType"/>.
        /// </summary>
        /// <param name="value">The value to check.</param>
        /// <returns>Whether the value represents zero.</returns>
