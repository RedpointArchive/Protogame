...
namespace Protogame
{
    ...
    public sealed class MxMessageSerializer : TypeModel
    {
        ...
        private static void Write(MxMessage mxMessage, ProtoWriter protoWriter)
        {
            ...
            {
                TypeModel.ThrowUnexpectedSubtype(typeof(MxMessage), mxMessage.GetType());
            }
            ...
            if (expr_A1 != null)
            {
                ...
                for (int i = 0; i < array.Length; i++)
                {
                    ...
                    if (expr_B5 != null)
                    {
                        ...
                        MxMessageSerializer.Write(expr_B5, protoWriter);
        ...
        private static MxMessage Read(MxMessage mxMessage, ProtoReader protoReader)
        {
            ...
            while ((num = protoReader.ReadFieldHeader()) > 0)
            {
                if (num != 1)
                {
                    if (num != 2)
                    {
                        if (num != 3)
                        {
                            if (num != 4)
                            {
                                if (num != 6)
                                {
                                    if (mxMessage == null)
                                    {
                                        MxMessage expr_170 = new MxMessage();
                                ...
                                else
                                {
                                    ...
                                    do
                                    {
                                        ...
                                        MxPayload arg_111_1 = MxMessageSerializer.Read(arg_104_0, protoReader);
                                    ...
                                    MxPayload[] array = new MxPayload[(num2 = ((expr_124 != null) ? expr_124.Length : 0)) + list.Count];
                                    if (num2 != 0)
                                    {
                            ...
                            else
                            {
                                if (mxMessage == null)
                                {
                                    MxMessage expr_A9 = new MxMessage();
                        ...
                        else
                        {
                            if (mxMessage == null)
                            {
                                MxMessage expr_79 = new MxMessage();
                    ...
                    else
                    {
                        if (mxMessage == null)
                        {
                            MxMessage expr_49 = new MxMessage();
                ...
                else
                {
                    if (mxMessage == null)
                    {
                        MxMessage expr_19 = new MxMessage();
            ...
            if (mxMessage == null)
            {
                MxMessage expr_198 = new MxMessage();
        ...
        private static void Write(MxPayload mxPayload, ProtoWriter writer)
        {
            ...
            {
                TypeModel.ThrowUnexpectedSubtype(typeof(MxPayload), mxPayload.GetType());
            }
        ...
        private static MxPayload Read(MxPayload mxPayload, ProtoReader protoReader)
        {
            ...
            while ((num = protoReader.ReadFieldHeader()) > 0)
            {
                if (num != 1)
                {
                    if (mxPayload == null)
                    {
                        MxPayload expr_49 = new MxPayload();
                        ProtoReader.NoteObject(expr_49, protoReader);
                        mxPayload = expr_49;
                    }
                    protoReader.SkipField();
                ...
                else
                {
                    if (mxPayload == null)
                    {
                        MxPayload expr_19 = new MxPayload();
                        ProtoReader.NoteObject(expr_19, protoReader);
                        mxPayload = expr_19;
                    }
            ...
            if (mxPayload == null)
            {
                MxPayload expr_71 = new MxPayload();
        ...
        {
            return ((IList)MxMessageSerializer.knownTypes).IndexOf(value);
        }
        ...
        protected override void Serialize(int num, object obj, ProtoWriter protoWriter)
        {
            ...
            {
                case 0:
                    MxMessageSerializer.Write((MxMessage)obj, protoWriter);
                    return;
                case 1:
                    MxMessageSerializer.Write((MxPayload)obj, protoWriter);
                    return;
                default:
                    return;
            }
        ...
        protected override object Deserialize(int num, object obj, ProtoReader protoReader)
        {
            ...
            {
                case 0:
                    return MxMessageSerializer.Read((MxMessage)obj, protoReader);
                case 1:
                    return MxMessageSerializer.Read((MxPayload)obj, protoReader);
                default:
                    return null;
            }
        }
