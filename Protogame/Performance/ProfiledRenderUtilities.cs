...
namespace Protogame
{
    public class ProfiledRenderUtilities : IRenderUtilities
    {
        private IProfiler m_Profiler;
        
        public ProfiledRenderUtilities(IProfiler profiler)
        {
        ...
        {
            using (this.m_Profiler.Measure("render_text"))
            {
        ...
        public Vector2 MeasureText(
            ...
            FontAsset font)
        {
            using (this.m_Profiler.Measure("measure_text"))
            {
                if (context == null) throw new ArgumentNullException("context");
        ...
        {
            using (this.m_Profiler.Measure("render_texture"))
            {
                if (size == null)
        ...
        public void RenderLine(
            ...
            float width = 1f)
        {
            using (this.m_Profiler.Measure("render_line"))
            {
        ...
        public void RenderRectangle(
            ...
            bool filled = false)
        {
            using (this.m_Profiler.Measure("render_rectangle"))
            {
                if (filled)
                {
                    context.SpriteBatch.Draw(
