...
namespace Protogame
{
    ...
    public class PhysicsCollisionBeginEvent : PhysicsEvent
    {
        /// <summary>
        /// Initializes a new instance of a <see cref="PhysicsCollisionBeginEvent"/>.  This constructor
        ...
        public PhysicsCollisionBeginEvent(
